...
pub fn assamese_schema() -> TransliterationSchema {
    ...
    consonants.insert("চ".to_string(), vec!["s".to_string(), "c".to_string()]);
    consonants.insert("ছ".to_string(), vec!["S".to_string(), "ss".to_string(), "Ss".to_string(), "SS".to_string(), "cc".to_string(), "Cc".to_string(), "CC".to_string()]);
    consonants.insert("জ".to_string(), vec!["j".to_string(), "z".to_string()]);
    consonants.insert("ঝ".to_string(), vec!["jh".to_string(), "jH".to_string(), "Jh".to_string(), "JH".to_string()]);
    consonants.insert("ঞ".to_string(), vec!["yy".to_string(), "Y".to_string()]);
    ...
    consonants.insert("য".to_string(), vec!["J".to_string(), "jj".to_string(), "JJ".to_string(), "Jj".to_string(), "Z".to_string(), "zz".to_string(), "ZZ".to_string(), "Zz".to_string()]);
    consonants.insert("ৰ".to_string(), vec!["r".to_string()]);
    consonants.insert("ল".to_string(), vec!["l".to_string(), "L".to_string()]);
    consonants.insert("ৱ".to_string(), vec!["w".to_string(), "W".to_string()]);
    consonants.insert("স".to_string(), vec!["x".to_string(), "X".to_string()]);
    consonants.insert("শ".to_string(), vec!["xx".to_string(), "Xx".to_string(), "xX".to_string(), "XX".to_string()]);
    consonants.insert("ষ".to_string(), vec!["xxx".to_string(), "XxX".to_string(), "xXX".to_string(), "XXX".to_string(), "xxX".to_string(), "xXx".to_string(), "Xxx".to_string()]);
    ...
    consonants.insert("য়".to_string(), vec!["y".to_string()]);
    consonants.insert("ক্ষ".to_string(), vec!["khyy".to_string()]);
    ...
    vowel_marks.insert("ী".to_string(), vec!["ii".to_string()]);
    vowel_marks.insert("ু".to_string(), vec!["u".to_string()]);
    vowel_marks.insert("ূ".to_string(), vec!["uu".to_string(), "U".to_string()]);
    vowel_marks.insert("ৃ".to_string(), vec!["riii".to_string()]);
    vowel_marks.insert("ে".to_string(), vec!["e".to_string()]);
    vowel_marks.insert("ৈ".to_string(), vec!["oi".to_string()]);
    vowel_marks.insert("ো".to_string(), vec!["uuu".to_string(), "oo".to_string(), "O".to_string()]);
    vowel_marks.insert("ৌ".to_string(), vec!["ou".to_string()]);

    let mut special_char = HashMap::new();
    special_char.insert("ং".to_string(), vec!["ngg".to_string(), "Ngg".to_string(), "nGg".to_string(), "NGg".to_string(), "ngG".to_string(), "NgG".to_string(), "nGG".to_string(), "NGG".to_string()]);
    special_char.insert("ঃ".to_string(), vec!["hh".to_string(), "HH".to_string(), "hH".to_string(), "Hh".to_string()]);
    special_char.insert("ঁ".to_string(), vec!["*".to_string()]);
    special_char.insert("ৎ".to_string(), vec!["t".to_string(), "T".to_string()]);
    ...
    special_combinations.insert("gyy".to_string(), "জ্ঞ".to_string());
    special_combinations.insert("jyy".to_string(), "হ্য".to_string());
    special_combinations.insert("khm".to_string(), "ক্ষ্ম".to_string());

    let mut joined_consonants_before = HashMap::new();
    joined_consonants_before.insert("চ".to_string(), "স".to_string());

    let mut joined_consonants_after = HashMap::new();
    joined_consonants_after.insert("w".to_string(), "ব".to_string());
    joined_consonants_after.insert("y".to_string(), "য".to_string());

    let exceptions = Exceptions {
        special_combinations,
        joined_consonants_before,
